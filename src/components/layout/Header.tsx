...
export default function Header() {
  ...
  // Use transparent background during SSG, only apply scroll-based styling after mount
  ...
  return (
    <header 
      className={`fixed top-0 left-0 right-0 z-50 w-full transition-all duration-300 ${headerBg}`}
    >
      <div className="container flex h-20 items-center justify-between">
        ...
        {/* Mobile Menu - wrapped in ClientOnly to prevent hydration mismatch from portal */}
        <ClientOnly fallback={
